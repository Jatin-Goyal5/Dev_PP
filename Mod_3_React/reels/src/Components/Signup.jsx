        ...
        <Grid container style={{justifyContent:"center"}}>
          ...
          <Grid item sm={3}>
            <Card variant="outlined" className={classes.mb}>
              <CardMedia
                image={logo} style={{ height: "5rem", backgroundSize: "contain" }}
              ></CardMedia>
              <CardContent className={classes.centerElements}>
                <Typography style= {{textAlign:"center"}}>
                  Signup to see photos and videos from your friends
                </Typography>
              <TextField label="Username" type="text"  variant="outlined"  value={username} size="small"
                ...
                ></TextField>
                <TextField
                  label="Password" type="password" variant="outlined" value={password}
                  size="small"
